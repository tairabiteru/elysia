...
Elysia's Model-View Controller *IS* Django, albeit a heavily modified version of it. I
...
and in fact, that WAS what Elysia used to use. However, Sanic is only one half of what
...
...Oh right! Should probably detail the contents of this file, huh?
    ...
    * main - Function implementing the behavior of this file when run via 'elysia mvc'
"""
